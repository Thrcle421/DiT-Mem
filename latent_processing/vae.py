...
class WanVAE:
    ...
    def encode(self, videos):
        """Encode videos to latent vectors.
        
        Args:
            videos: List of videos, each with shape [C, T, H, W]
        """
